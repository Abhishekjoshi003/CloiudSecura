			...
			<div class="wrap-login100">
				<form action="process.php" method="POST" class="login100-form validate-form">
					<span class="login100-form-logo">
						...
						<img src="icons/cloud.ico" width="170px" height = "100px" alt="">
					</span>
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						<input class="input100" id="password" type="type" name="email" placeholder="email">
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>
					...
					<div class="container-login100-form-btn">
						...
						<input class="login100-form-btn" type="submit" value="LOGIN" name="btn-save" class="loginbtn">
					</div>
