...
<?php
require "connection.php";
function Register($Staff_Name,$Staff_Surname,$Staffjoining,$Staff_Email,$Staff_Password,$private,$public)
{
$db = new PDO('mysql:host=localhost;dbname=secure_cloud1;charset=utf8', 'root', '');
$sql = $db->prepare("insert into register_user(Staff_Name,Staff_Surname,staff_joining,Staff_Email,Staff_Password,user_private_key,user_public_key) 
VALUES (:Staff_Name,:Staff_Surname,:Staffjoining,:Staff_Email,:Staff_Password,:private,:public)");
$sql->bindParam(':Staff_Name', $Staff_Name);
$sql->bindParam(':Staff_Surname', $Staff_Surname);
$sql->bindParam(':Staffjoining', $Staffjoining);
$sql->bindParam(':Staff_Email', $Staff_Email);
$sql->bindParam(':Staff_Password', $Staff_Password);
$sql->bindParam(':private', $private);
$sql->bindParam(':public', $public);
$sql->execute();
if($sql->rowCount())
{
return 1;
