          ...
          <div class="panel-body">
            <div class="table-responsive">
              <?php
									...
									if(delete_vid($id)==1)
									{
									echo "<script>window.location='delete_videos.php?id=done';</script>";
									}
									else
									{
									echo "<script>window.location='delete_videos.php?id=notdone';</script>";
									}
									}
									?>
              <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="?delete=<?php echo $id; ?>" type="button" class="btn btn-danger">Delete</a></td>
                  </tr>
                </tbody>
                <?php } ?>
              </table>
