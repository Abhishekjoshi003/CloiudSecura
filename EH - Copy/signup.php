...
require "includes/DB_Functions.php";
 ?>
<?php
if(isset($_POST['username']) && isset($_POST['password']) && isset($_POST['email'])  && isset($_POST['branch']))
{
...
if(Signup($name,$password,$email,$branch)==1)
{
$_SESSION['name']=$email;
echo "<script>window.location='index.php';</script>";
}
	...
	<div class="grid_12 columns">
		<div class="tab style-1">
    					...
    					<ul>
    						<li class="active">
			    				<div class="form">
                                <img src="images/signupfb.png">
                                		<br><br>
                                 <img src="images/or.jpg">
                                 <form action="signup.php" method="POST">
			<input type="text" required name="username" class="active textbox" placeholder="User Name">
			<input type="password" required name="password" class="textbox" placeholder="Password" >
			<input type="email" required name="email" class="textbox" placeholder="Email Address" >
            <input type="number" required name="contact" class="textbox" placeholder="Contact Number" >
            <input type="text" required name="branch" class="textbox" placeholder="Branch" >
